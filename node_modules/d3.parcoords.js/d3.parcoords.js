//$.getScript("../d3/build/d3.js");
//var d3 = require("d3");

//import d3 from "./examples/lib/d3";
...
function rotateLabels() {
  ...
  pc.svg.selectAll("text.label")
    .attr("transform", "translate(0,-12) rotate(" + __.dimensionTitleRotation + ")");
...
(function() {
    ...
    brush
      ...
      .on("brushstart", function() {
      	if(d3.event.sourceEvent !== null) {
			...
			.on("brush", function() {        
        angular2BrushEffectFix();
				//brushUpdated(selected());
			})
			.on("brushend", function() {
				//events.brushend.call(pc, __.brushed);
        //FIX for Angular2        
        angular2BrushEndEffectFix();
  ...
  function angular2BrushEffectFix(){
    __.brushed = selected();
    pc.highlight(__.brushed);
  }

  function angular2BrushEndEffectFix(){
    if(__.brushed.length<__.data.length){
            //$("canvas.foreground").addClass( "faded" );
            //$("canvas.brushed").addClass( "faded" );
            pc.unhighlight();
            pc.highlight(__.brushed);
        }
        else{
            pc.unhighlight();
            //$("canvas.foreground").removeClass( "faded" );
            //$("canvas.brushed").removeClass( "faded" );
            //$("canvas.highlight").removeClass( "faded" );
            //$("canvas.background").removeClass( "faded" );
        }
  }
